            ...
            <Table className={classes.table}>
                <TableHead>
                    <TableRow>
                        ...
                        <StyledTableCell align="right" className={classes.tableHead}>Totalt beløp</StyledTableCell>
                    </TableRow>
                </TableHead>
                <TableBody>
                    <StyledTableRow key={"I dag"}>
                        <StyledTableCell colSpan={2} component="th" scope="row" className={classes.tableSubType}>
                            Betalinger i dag
                        </StyledTableCell>
                    </StyledTableRow>
                    {rowsToday.map(row => (
