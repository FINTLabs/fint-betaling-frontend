...
import {
  CheckCircle, Edit, PaymentRounded, PriorityHigh, Warning,
...
const PaymentsTable = () => {
  ...
  const paymentNotSentFeedback = 'Ordre er lagret, men ikke sendt til økonomisystem. Klikk på \'Send ordre\' i' +
