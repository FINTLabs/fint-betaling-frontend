        ...
        <Box minWidth="80%" mt={4}>
            ...
            >
                ...
                <Box m={1}>
                    <Typography variant="body1">
                        Søk på ordrenummer eller navn i feltet under. Du kan filtrere på status, ordrenummer, navn og tidspunkt.
                    </Typography>
                </Box>
            </Box>
            <Box display="flex" justifyContent="center" mt={3}>
                <FormControl component="fieldset" className={classes.formControl}>
                    ...
                    <FilterSelect />
                    <ShowOnlyMeCheckBox classes={classes} handleOnlyMeCheck={handleOnlyMeCheck} checked={searchOnlyMe}/>
                    </Box>
                </FormControl>
            </Box>
            <PaymentSearch />
